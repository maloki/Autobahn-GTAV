...
namespace HighBeam
{
    public class HighwayZoneModel
    {
        ...
        public int SpeedLimitLeftLane { get; set; }
        public int SpeedLimitRightLane { get; set; }
        public BeaconModel Beacons { get; set; }
        public bool HasHill { get; set; }
        public bool IsThreeLaneRoad { get; set; }
    }

    public class BeaconModel
    {
        public Vector3 Offset { get; set; }
        public Vector3 OffsetInside { get; set; }

...
namespace HighBeam
{
    public static class HighwayTrafficOld
    {
            ...
            if (CurrentZone.Name != null)
            {
                ...
                for (var fk = 0; fk < fakeLightList.Count; fk++)
                {
                    ...
                    else
                    {
                        ...
                        light.Vehicle.ApplyForceRelative(new Vector3(0, 0, -0.2f));
                    }
                }
            ...
            try
            {
                ...
                for (var cra = 0; cra < carList.Count; cra++)
                {
                    ...
                    if (!car.Stats.Deleted)
                    {
                        ...
                        if (!car.Stats.accelerate && !car.Stats.deccelerate)
                        {
                            car.Vehicle.Speed = car.Stats.DefaultSpeed;
                        }
                        car.Vehicle.ApplyForceRelative(new Vector3(0, 0, -0.2f));
        ...
        private static TrafficHoursModel GetTraffic()
        {
            ...
            if (h >= 9 && h < 14)
            {
                maxNumOfSpawnedCars = 19;
                minFake = 13;
                maxFake = 21;
            }
            if (h == 14)
            {
                maxNumOfSpawnedCars = 9;
                minFake = 18;
                maxFake = 25;
            }
            if (h >= 15 && h < 18)

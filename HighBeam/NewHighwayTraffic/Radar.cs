...
namespace HighBeam.NewHighwayTraffic
{
    public static class Radar
    {
        ...
        public static void NewRadar(GeneralCar car)
        {
            ...
            int meter = 6;
            if (speed - (car.Stats.DefaultSpeed * 3.6) > 26)
            {
                meter = 66;
            }

            else if (car.Vehicle.Position.DistanceTo(Index.veh.Position) < 20)
            {
                meter = 20;
            }
            else if (isCarAroundBehind && car.Stats.forcedLeftLane)
            {
                meter = 150;
            }
            else if (!isCarAroundBehind && car.Stats.forcedLeftLane)
            ...
            if ((speed > 210 && (isEvening || isNight)) || bro != null)
            {
                meter = 100;
            }

            if (car.Stats.DefaultSpeed * 3.6 > 130 && car.Vehicle.Position.DistanceTo(Index.veh.Position) < meter)
            {
                var v = car.Vehicle;
                ...
                if (isLeftLane)
                {
                    ...
                    if (isSideCar == null && !car.Stats.forcedLeftLane)
                    {
                        turnRight(car);
                    }
        ...
        {
            UI.ShowSubtitle("checking");
            if (Index.veh.Speed * 3.6 >= ((currentCar.Vehicle.Speed * 3.6) + 6) && currentCar.Stats.isLeftLane && Index.veh.Position.DistanceTo(currentCar.Vehicle.Position) < 80)
            {
        ...
        public static void turnRight(GeneralCar c)
        {
        ...
        public static void turnLeft(GeneralCar c)
        {
